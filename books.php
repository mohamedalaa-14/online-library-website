...
<button style="background-color:#6db6b9ed;" type="submit" name="submit1" class="btn btn-default">Delete
...
if(isset($_POST['submit']))
{
	...
	{
		echo "sorry!No book found.try searchin again.";
	}
	else
	{
